...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['CodProveedor'])) {
        ...
        // Consulta para obtener los datos del proveedor por su código
        ...
        // Si la solicitud no es válida, devuelve un mensaje de error
        echo json_encode(["error" => "Solicitud no válida."]);
    }
} catch (PDOException $e) {
    // Si ocurre un error con PDO, devuelve un mensaje de error
